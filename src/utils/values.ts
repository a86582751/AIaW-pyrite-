...
const models: Model[] = [
  ...
  // GPT-5.4 系列 - 支持联网搜索和思考模式
  { name: 'gpt-5.4', inputTypes: InputTypes.commonVision },
  { name: 'gpt-5.4-2026-01-15', inputTypes: InputTypes.commonVision },
  { name: 'gpt-5.4-mini', inputTypes: InputTypes.commonVision },
  { name: 'gpt-5.4-mini-2026-01-15', inputTypes: InputTypes.commonVision },
  { name: 'gpt-5.2', inputTypes: InputTypes.commonVision },
  { name: 'gpt-5.2-2025-11-12', inputTypes: InputTypes.commonVision },
  { name: 'gpt-5.2-mini', inputTypes: InputTypes.commonVision },
  { name: 'gpt-5.2-mini-2025-11-12', inputTypes: InputTypes.commonVision },
  ...
  // Gemini 3 系列 - 支持联网搜索和思考模式
  { name: 'gemini-3.1-pro', inputTypes: InputTypes.gemini2 },
  { name: 'gemini-3.1-pro-preview', inputTypes: InputTypes.gemini2 },
  { name: 'gemini-3.1-flash', inputTypes: InputTypes.gemini2 },
  { name: 'gemini-3.1-flash-preview', inputTypes: InputTypes.gemini2 },
  { name: 'gemini-3.1-flash-image-preview', inputTypes: InputTypes.geminiImage },
  { name: 'gemini-3-pro', inputTypes: InputTypes.gemini2 },
  { name: 'gemini-3-pro-preview', inputTypes: InputTypes.gemini2 },
  { name: 'gemini-3-flash', inputTypes: InputTypes.gemini2 },
